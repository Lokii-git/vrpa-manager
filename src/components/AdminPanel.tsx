...
import { Plus, Trash, PencilSimple, User, FileText } from '@phosphor-icons/react';
...
interface AdminPanelProps {
  ...
  onSaveEmailTemplate: (content: string) => void;
}

export function AdminPanel({ teamMembers, onAddUser, onUpdateUser, onRemoveUser, onSaveEmailTemplate }: AdminPanelProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Manage team members, settings, and email templates</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="users" className="space-y-6">
        ...
        <TabsContent value="email-template">
          <EmailTemplateEditor onSave={onSaveEmailTemplate} />
        </TabsContent>
      </Tabs>
    </div>
  );
